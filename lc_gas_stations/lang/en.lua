...
Lang['en'] = {
    ...
    ['cannot_do_own_job'] = "You cannot be hired by your own gas station",
    ['already_has_business'] = "You already have a gas station",
    ['already_has_owner'] = "This gas station already has an owner",
    ['businnes_bougth'] = "Congratulations, you have purchased a gas station",
    ['insufficient_funds'] = "Insufficient money",
    ['insufficient_funds_store'] = "Insufficient money to buy this gas station: %s",
    ...
    ['objective_marker_3'] = "Press ~y~[E]~w~ to transfer the products",
    ['sucess_2'] = "~g~Success",
    ...
    ['stock_full'] = "The gas station's stock is full",
    ...
    ['sell_error'] = "You cannot sell this gas station",
    ['store_sold'] = "You sold this gas station",
